...
CREATE TABLE VEHICULO (
    ...
    ClienteCI INTEGER NOT NULL,
    FOREIGN KEY (ClienteCI) REFERENCES CLIENTE(CI)
		ON UPDATE CASCADE
		ON DELETE CASCADE
);
...
INSERT INTO PERSONA VALUES ('7679493', 'Juan', 'Pérez', 'Av. Brasil 432', '5551234', 'j.perezl@gmail.com', TRUE, FALSE);
INSERT INTO PERSONA VALUES ('7328931', 'María', 'Gómez', 'Calle Bolivar 456', '5555678', 'margom@outlook.com', TRUE, TRUE);
INSERT INTO PERSONA VALUES ('7436482', 'Carlos', 'López', 'Av. Los Laureles 789', '5557890', 'carlopez52@google.com', FALSE, TRUE);

INSERT INTO CLIENTE VALUES ('7679493', '2023-01-15');
INSERT INTO CLIENTE VALUES ('7328931', '2023-02-20');

INSERT INTO EMPLEADO VALUES ('7436482', 'Lavador', '2023-06-10');
INSERT INTO EMPLEADO VALUES ('7328931', 'Gerente', '2022-08-15');
